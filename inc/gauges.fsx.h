...
#define _CR      0x0d                // ASCII carriage return
#define _LF      0x0a                // ASCII line feed
...
#define	KEY_FREEZE_ATTITUDE_TOGGLE				(KEY_ID_MIN + 1293)
#define	KEY_FREEZE_ATTITUDE_SET					(KEY_ID_MIN + 1294)
...
typedef struct  ENG
{
    ...
    UINT32      rotor_rpm;              // main rotor speed_restr * 16384, % max
...
typedef enum    GAUGE_TOKEN
{
    ...
    GROUND_ALTITUDE,            //  ground level altitude_restr (1/256 meter/unit)
    ...
    PITOT_HEAT,                 //  TRUE=pitot_heat heat on
    ...
    NAV2_VOR_RADIAL,
    NAV2_MORSE_IDENT,
    DME1_DISPLAY_TYPE,          //  FALSE=distance readout,  TRUE=speed_restr in kts readout
    DME1_DISTANCE,              //  DME1 distance readout
    DME1_SPEED,                 //  DME1 speed_restr readout
    DME1_MORSE_IDENT,
    DME2_DISPLAY_TYPE,          //  FALSE=distance readout,  TRUE=speed_restr in kts readout
    DME2_DISTANCE,              //  DME2 distance readout
    DME2_SPEED,                 //  DME2 speed_restr readout
    DME2_MORSE_IDENT,
    ...
    VERTICAL_SPEED,             //  Velocity Up, vertical speed_restr {1/256th m/sec}
    MACH_MAX_OPERATE,
    ...
    AUTOPILOT_ALTITUDE_LOCK,    //  altitude_restr lock on/off
    AUTOPILOT_ALTITUDE_LOCK_VAR,//  altitude_restr lock altitude_restr in appropriate units
    ...
    AUTOPILOT_VERTICAL_HOLD_VAR,//  vertical speed_restr hold var in appropriate units
    ...
    CG_MAX_MACH,
    CG_MIN_MACH,
    STANDARD_ATM_TEMPERATURE,   // standard atmosphere temperature at aircraft's altitude_restr; celsius
...
typedef FLOAT64 FSAPI FN_FLOAT64      ( FLOAT64       logical_val );
typedef               FN_FLOAT64      *PFN_FLOAT64;
    
typedef FLOAT64 FSAPI MODULE_VAR_CB   ( PMODULE_VAR   logical_val );
